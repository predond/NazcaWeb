...
namespace NazcaWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            Task.Run(() =>
            {
                VideoModel.GetVideos(@"\\DISKSTATION\video1\Filmy Dawid\Private");
        ...
        [HttpPost]
        public void ChangeFileName([FromBody]VideoItem video)
        {
            if (video != null)
            {
                //_irc.ChangeFileName(new VideoItem("Test") { FullPath = @"C:\Users\Dawid\Desktop\Test\ABC.txt.mts" }, "Piecadło", "mp4");
            }
        }
